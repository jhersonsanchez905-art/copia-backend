...
class CierreCaja(Base):
    ...
    turno               = Column(String, nullable=False)
    fecha               = Column(Date, nullable=False)
    total_general       = Column(Numeric(16, 2), nullable=False)
    total_transacciones = Column(Numeric(16, 2), nullable=False)
    diferencia          = Column(Numeric(16, 2), nullable=False)
    hora_cierre         = Column(DateTime(timezone=True), nullable=False, default=_utcnow)
    observaciones       = Column(String)
...
class CierreCajaDetalle(Base):
    ...
    total_esperado  = Column(Numeric(16, 2), nullable=False)
    total_contado   = Column(Numeric(16, 2), nullable=False)
    diferencia      = Column(Numeric(16, 2), nullable=False)
