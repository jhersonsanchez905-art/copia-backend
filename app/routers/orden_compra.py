...
def listar_ordenes_compra(skip: int = 0, limit: int = 100, db: Session = Depends(get_db), current_user: Usuario = Depends(get_current_user)):
...
def obtener_orden_compra(id_orden_compra: int, db: Session = Depends(get_db), current_user: Usuario = Depends(get_current_user)):
...
def crear_orden_compra(data: OrdenCompraCreate, db: Session = Depends(get_db), current_user: Usuario = Depends(require_rol("administrador"))):
...
def actualizar_orden_compra(id_orden_compra: int, data: OrdenCompraUpdate, db: Session = Depends(get_db), current_user: Usuario = Depends(require_rol("administrador"))):
...
def eliminar_orden_compra(id_orden_compra: int, db: Session = Depends(get_db), current_user: Usuario = Depends(require_rol("administrador"))):
...
def listar_detalles(id_orden_compra: int, db: Session = Depends(get_db), current_user: Usuario = Depends(get_current_user)):
...
def crear_detalle(id_orden_compra: int, data: OrdenCompraDetalleCreate, db: Session = Depends(get_db), current_user: Usuario = Depends(require_rol("administrador"))):
...
def actualizar_detalle(id_detalle: int, data: OrdenCompraDetalleUpdate, db: Session = Depends(get_db), current_user: Usuario = Depends(require_rol("administrador"))):
...
def eliminar_detalle(id_detalle: int, db: Session = Depends(get_db), current_user: Usuario = Depends(require_rol("administrador"))):
